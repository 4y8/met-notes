...
\begin{figure}[h]
  ...
  \inferrule[Sub-Mod]{\Gamma\vdash G\subt G'\dashv\Delta{\color{gray} \dashrightarrow M}}
    {\Gamma\vdash\overline{\mu} G\subt\overline{\mu} G'\dashv\Delta{\color{gray} \dashrightarrow \lambda x^{\overline{\mu} G} . \textsf{\textbf{let mod}}_{\overline{\mu}} x = x \textsf{\textbf{ in }} (\lambda y^{G'}. \kmod_\mu y) (M x) }}
  \end{mathpar}
...
\begin{figure}[h]
  \begin{mathpar}
    \inferrule[B-Switch]
      {\Gamma\vdash V\Rightarrow\overline{\mu}G'\ectx{E}
        {\color{gray} \dashrightarrow M'}\\
      ...
      {\Gamma\vdash V \Leftarrow\overline{\nu}G \dashv\Delta\ectx{E}
       {\color{gray} \dashrightarrow N}}
